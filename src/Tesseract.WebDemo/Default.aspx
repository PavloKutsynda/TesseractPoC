        ...
        <form id="Form1" method="post" role="form" runat="server">
            ...
            <asp:Panel ID="resultPanel" Visible="False" runat="server">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="result" runat="server">Result: page.GetText()</label>
                        <textarea class="form-control" rows="10" id="resultText" readonly="readonly" runat="server"></textarea>
                        <label for="result" runat="server">Result:  page.GetHOCRText(1, false);</label>
                        <textarea id="ResultTextHtmlTextArea" class="form-control" rows="10" readonly="readonly" runat="server"></textarea>
                        <label for="result" runat="server">Result:   page.GetHOCRText(1, true)</label>
                        <textarea id="ResultTextXHtmlTextArea" class="form-control" rows="10" readonly="readonly" runat="server"></textarea>
                        <label for="result" runat="server">Result:   XML</label>
                        <textarea id="ResultXml" class="form-control" rows="10" readonly="readonly" runat="server"></textarea>
                    </div>
